            ...
            <div className="nav-icons flex items-center lg_992:order-2 ms-auto md:ms-8">
                ...
                <ul className="list-none menu-social mb-0">
                    <li className="inline-flex">
                        <Link to="https://www.linkedin.com/in/digital-duo-a1b2a2290" className="ms-1">
                            ...
                            <span className="login-btn-light"><span className="btn btn-icon btn-sm rounded-full bg-amber-500 hover:bg-amber-600 border-amber-500 hover:border-amber-600 text-white"><Unicons.UilLinkedin width={16}/></span></span>
                        </Link>
